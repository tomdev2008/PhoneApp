...
@interface FreeGiftItemDetailsVC : UIViewController<UIPickerViewDataSource,UIPickerViewDelegate,GfitZoomInViewDelegate,Facebook_GiftGivDelegate,AddUserRequestDelegate>{
    CGPoint svos;
